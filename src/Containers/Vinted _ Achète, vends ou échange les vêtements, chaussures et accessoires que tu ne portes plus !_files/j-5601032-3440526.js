//Generated:2021-05-05 19:38:49// 6-245
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5601032 || '',
    guid: window.ftGUID_5601032 || '',
    confID: window.ftConfID_5601032 || '0',
    ftReturn: window.ftReturn_5601032 || '',
    keyword: window.ftKeyword_5601032 || '',
    ftId: window.ftId_5601032 || '',
    ftImpId: window.ftImp5601032 && window.ftImp5601032.impID || '',
    gdpr: window.ftImp5601032 && window.ftImp5601032.gdpr || '',
    gdpr_consent: window.ftImp5601032 && window.ftImp5601032.gdpr_consent || '',
    gdpr_pd: window.ftImp5601032 && window.ftImp5601032.gdpr_pd || '',
    us_privacy: window.ftImp5601032 && window.ftImp5601032.us_privacy || '',
    campaignID: '152970',
    cID: '142606',
    pID: '5601032',
    creativeID: '3440526',
    exttrack: [
      '[%FT_PROTOCOL%]://match.adsrvr.org/track/cmf/generic?ttd_pid=vbcx51j&ttd_tpi=1&ttd_passthrough=xid%3D5601032;3440526;[%FT_CONFID%];402;[%FT_IMPRESSIONID%]'
    ],
    extscript: [
      "https://sejs.moatads.com/pgsmvfranceft495840516441_nlsn/moatad.js?moatClientLevel1=152970#moatClientLevel2=9622&moatClientLevel3=5601032&moatClientLevel4=3440526&zMoatImpID=[IMPRESSIONID]&[ftqs:[ft_c2]][noCachebuster]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/1/152970;5601032;3440526;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.oralb.fr/fr-fr/produits-dentaires/brosses-a-dents-electriques#series=vitality?utm_source=TTD&utm_medium=HTML&utm_campaign=FR_OC-TT_DNS_IME_060521_ALL25-49_ORALB-GeotargetingLidl_M2021-62268-C2021-62269&utm_content=TTD-TheTradeDesk_CPM_RON_DISPLAY_MUL_GEO_GeotargetingLidl-728x90-728x90-ORALBGeotargetingLidl'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?206757211-5601032;3440526;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/560/5601032/3440526/image/3440526.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/1/152970;5601032;202;pixel;TheTradeDesk;TTDTheTradeDeskCPMRONDISPLAYMULGEOGeotargetingLidl728x90728x90ORALBGeotargetingLidl/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/1/152970;5601032;3440526;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.oralb.fr/fr-fr/produits-dentaires/brosses-a-dents-electriques#series=vitality?utm_source=TTD&utm_medium=HTML&utm_campaign=FR_OC-TT_DNS_IME_060521_ALL25-49_ORALB-GeotargetingLidl_M2021-62268-C2021-62269&utm_content=TTD-TheTradeDesk_CPM_RON_DISPLAY_MUL_GEO_GeotargetingLidl-728x90-728x90-ORALBGeotargetingLidl',
    divID: 'ftdiv5601032',
    altimgID: 'ftalt5601032',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5601032 && parseInt(window.ftImp5601032.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5601032') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5601032'),
    pageVisible: 'maybe',
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/1/152970;5601032;202;pixel;TheTradeDesk;TTDTheTradeDeskCPMRONDISPLAYMULGEOGeotargetingLidl728x90728x90ORALBGeotargetingLidl/?ft_creative=3440526&ft_configuration=";
    ft.viewableConversion = "true"==="true";
