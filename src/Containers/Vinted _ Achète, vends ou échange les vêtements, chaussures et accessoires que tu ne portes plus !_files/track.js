...
if (_lm_id == "")
	...
	if (typeof document.cookie !== "undefined")
		{
		var myCookieMatches = document.cookie.match(/_lim_id=(.+)/);
...
if (typeof _lm_vars != "undefined")
	{
	if (typeof _lm_vars["xid"] != "undefined")
		_lm_pixel_url_querystring = _lm_add_to_querystring(_lm_pixel_url_querystring, "xid", _lm_vars["xid"]);
	...
	if (typeof _lm_vars["numorder"] != "undefined")
		_lm_pixel_url_querystring = _lm_add_to_querystring(_lm_pixel_url_querystring, "numorder", _lm_vars["numorder"]);
